...
return [
    ...
    'support' => [
        'prompt' => "🛠 پشتیبانی — پیام یا عکس‌تان را ارسال کنید.\nبرای بازگشت: /back",
        'received' => 'پیام شما برای پشتیبانی ارسال شد ✅',
        'received_photo' => 'پیام تصویری شما برای پشتیبانی ارسال شد ✅',
        'invalid_photo' => '❗️ ارسال تصویر نامعتبر بود. لطفاً دوباره امتحان کنید.',
        'empty_message' => '❗️ لطفاً متن پیام را بنویسید یا یک تصویر ارسال کنید.',
        'photo_without_caption' => '(بدون متن)',
    ],
];
